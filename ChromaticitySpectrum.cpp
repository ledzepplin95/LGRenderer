...
LG_IMPLEMENT_DYNCREATE(ChromaticitySpectrum,SpectralCurve)

float ChromaticitySpectrum::S0Amplitudes[]={ 0.04f, 6.0f, 29.6f, 55.3f,
...
68.6f, 65.0f, 66.0f, 61.0f, 53.3f, 58.9f, 61.9f,FLT_MAX };

float ChromaticitySpectrum::S1Amplitudes[]={ 0.02f, 4.5f, 22.4f, 42.0f,
...
-10.4f, -10.6f, -9.7f, -8.3f, -9.3f, -9.8f,FLT_MAX };

float ChromaticitySpectrum::S2Amplitudes[]={ 0.0f, 2.0f, 4.0f, 8.5f, 7.8f,
...
5.2f, 7.4f, 6.8f, 7.0f, 6.4f, 5.5f, 6.1f, 6.5f ,FLT_MAX};

RegularSpectralCurve ChromaticitySpectrum::kS0Spectrum(
	S0Amplitudes,300,830);
RegularSpectralCurve ChromaticitySpectrum::kS1Spectrum(
	S1Amplitudes,300,830);
RegularSpectralCurve ChromaticitySpectrum::kS2Spectrum(
	S2Amplitudes,300,830);

XYZColor ChromaticitySpectrum::S0xyz=ChromaticitySpectrum::kS0Spectrum.toXYZ();
XYZColor ChromaticitySpectrum::S1xyz=ChromaticitySpectrum::kS1Spectrum.toXYZ();
XYZColor ChromaticitySpectrum::S2xyz=ChromaticitySpectrum::kS2Spectrum.toXYZ();

ChromaticitySpectrum::ChromaticitySpectrum(float x,float y) 
{
...
float ChromaticitySpectrum::sample(float lambda)const 
{
	return kS0Spectrum.sample(lambda)+ 
		M1*kS1Spectrum.sample(lambda) 
		+M2*kS2Spectrum.sample(lambda);
}

XYZColor ChromaticitySpectrum::get(float x,float y) 
{
